...
// CHANGE webFont.currentFont IN LINE 72
var webFont = {};
...
fontItem.url = '';
fontItem.name = '';
fontItem.font = "'AppleGothic', '애플고딕', 'Malgun Gothic', '맑은 고딕', 'Dotum', '돋움', 'DotumChe', '돋움체', 'Gulim', '굴림', 'New Gulim', '새굴림', sans-serif";
webFont.korean = fontItem;

fontItem = {};
fontItem.url = '';
fontItem.name = '';
fontItem.font = "'メイリオ', 'Microsoft YaHei', '微软雅黑', 'STXihei', '华文细黑', sans-serif";
...
// AVAILABLE OPTIONS: cyrillic, latin, greek, vietnamese, thai, arabic, korean, japanese, chinese
webFont.currentFont = webFont.cyrillic; 
...
{   
	...
	xhr.onload = function()
	{
		...
		myCSS = myCSS.replace(new RegExp('font-family: \'' + webFont.currentFont.name + '\';', 'g'),"font-family: 'webFont';");	
		...
		WebFontConfig = 
		{
			custom: {families: ['webFont']},    
			loading: function() {},
			active: function() {start(); },
			inactive: function() {start(); },  
		};
