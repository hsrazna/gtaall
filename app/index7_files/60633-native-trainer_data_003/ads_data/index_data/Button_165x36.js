...
var drawButton = function(ctx) {
	...
	ctx.beginPath();
	ctx.moveTo(83,-15);
	ctx.quadraticCurveTo(83,-18,80,-18);
	ctx.lineTo(-79,-18);
	ctx.quadraticCurveTo(-82,-18,-82,-15);
	ctx.lineTo(-82,15);
	ctx.quadraticCurveTo(-82,18,-79,18);
	ctx.lineTo(80,18);
	ctx.quadraticCurveTo(83,18,83,15);
	ctx.lineTo(83,-15);
	ctx.closePath();
